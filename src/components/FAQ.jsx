...
const FAQ_ITEMS = [
  {
    question: "What is Nexjour?",
    answer:
      "Nexjour helps businesses connect customer interactions across channels and understand the complete journey in one place.",
  },
  {
    question: "Who is Nexjour built for?",
    answer:
      "Nexjour is designed for teams that want better visibility into customer experiences, support interactions, and journey patterns.",
  },
  {
    question: "What channels can Nexjour connect?",
    answer:
      "Nexjour can bring together interactions from websites, mobile apps, call centers, and physical locations.",
  },
  {
    question: "How does Nexjour help businesses?",
    answer:
      "It helps teams identify journey drop-offs, escalations, repeated contacts, unresolved issues, and other important patterns.",
  },
  {
    question: "How does Nexjour protect customer data?",
    answer:
      "Nexjour is designed with secure data handling and controlled access in mind. Specific security and compliance capabilities depend on the deployment.",
  },
  {
    question: "Can Nexjour integrate with existing systems?",
    answer:
      "Nexjour can be designed to connect with existing customer, support, and interaction data sources through APIs and data pipelines.",
  },
  {
    question: "Can I try Nexjour?",
    answer:
    ...
    <section className="nx-faq" id="faq">
      ...
      <div className="nx-faq__header">
        ...
        <p className="nx-faq__subtitle">
          Everything you need to know about how Nexjour connects your
          customer journeys.
        </p>
      </div>
